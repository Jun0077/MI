...
function GetLoadNav() {
    ...
    $.each(data, function (i) {
        ...
        if (row.F_ParentId == "0") {
            _html += '<li>';
            _html += '<a data-id="' + row.F_Id + '" href="#" class="dropdown-toggle"><i class="menu-icon ' + row.F_Icon + '"></i><span>' + row.F_FullName + '</span>' + (row.ChildNodes.length > 0 ? '<b class="arrow fa fa-angle-down"></b>' : '<b class="arrow"></b>') + ' </a>';
